...
(define-macro-test (defgeneric)
  ...
  '((defgeneric foo ()
      #9=(:method))
    syn:invalid-syntax-error #9# "must be of the form (:method QUALIFIER* LAMBDA-LIST DECLARATION* FORM*)")
  ;; Repeated options
  '((defgeneric foo ()
      (:generic-function-class bar)
      #10=(:generic-function-class bar))
    syn:invalid-syntax-error #10# ":GENERIC-FUNCTION-CLASS option must not be repeated")
  '((defgeneric foo (a)
      (:argument-precedence-order a)
      #11=(:argument-precedence-order a))
    syn:invalid-syntax-error #11# ":ARGUMENT-PRECEDENCE-ORDER option must not be repeated")
  '((defgeneric foo ()
      (:documentation "foo")
      #12=(:documentation "foo"))
    syn:invalid-syntax-error #12# ":DOCUMENTATION option must not be repeated")
  ...
  '(#14=(defgeneric #15=foo #16=(#17=a #18=b)
         ...
         (:generic-function-class #20=clazz))
    (:defgeneric
     ((:name                   . 1) (((:function-name () :name foo :source #15#)))
      (:lambda-list            . 1) (((:generic-function-lambda-list
                                       ...
                                       :source #16#)
                                      :evaluation :compound))
      (:generic-function-class . 1) (((:type-name () :name clazz :source #20#)))
      (:documentation          . 1) (((:documentation () :string #19# :source #19#))))
     :source #14#))
  '(#21=(defgeneric #22=foo #23=(#24=a #25=b)
          (:argument-precedence-order #26=b #27=a))
    (:defgeneric
     ((:name                      . 1) (((:function-name () :name foo :source #22#)))
      (:lambda-list               . 1) (((:generic-function-lambda-list
                                          ((:required . *) (((:required-parameter
                                                              ((:name . 1) (((:variable-name
                                                                              ()
                                          ...
                                          :source #23#)
                                         :evaluation :compound))
      (:argument-precedence-order . *) (((:variable-name () :name b :source #26#))
                                        ((:variable-name () :name a :source #27#))))
     :source #21#))
  '(#28=(defgeneric #29=foo #30=(#31=a)
          #32=(:method #33=:custom #34=1 #35="foo" #36=(#37=a)))
    (:defgeneric
     ((:name        . 1) (((:function-name () :name foo :source #29#)))
      (:lambda-list . 1) (((:generic-function-lambda-list
                            ((:required . *) (((:required-parameter
                                                ((:name . 1) (((:variable-name
                                                                ()
      ...
      (:method      . *) (((:method-description
                           ...
                           :evaluation :compound)))
     :source #28#))
  '(#38=(defgeneric #39=foo #40=()
           (:method-combination #41=progn))
    (:defgeneric
     ((:name               . 1) (((:function-name () :name foo :source #39#)))
      (:lambda-list        . 1) (((:generic-function-lambda-list () :source #40#)
                                  :evaluation :compound))
      (:method-combination . 1) (((:method-combination-name () :name progn :source #41#))))
     :source #38#))
  '(#42=(defgeneric #43=baz #44=()
          #45=(#46=:custom . #47=(1 2)))
    (:defgeneric
     ((:name        . 1) (((:function-name ():name baz :source #43#)))
      (:lambda-list . 1) (((:generic-function-lambda-list () :source #44#)
                           :evaluation :compound))
      (:option      . *) (((:generic-function-option
                            ((:name  . 1) (((:option-name () :name :custom :source #46#)))
                             (:value . 1) (((:unparsed
                                             ()
                                             :expression (1 2)
