      ...
      (:destructuring-lambda-list
       ((:required-section . 1)
        (((:required-section
          ...
          :evaluation :compound)))
       :source #9#))
    '(#13=(#14=&whole #15=whole #16=(#17=foo #18=&key #19=a) . (#20=&rest #21=fez))
      (:destructuring-lambda-list
       ((:whole-section . 1)
        (((:whole-section
           ((:keyword   . 1) (((:lambda-list-keyword
        ...
        (((:rest-section
          ...
          :evaluation :compound)))
       :source #13#))
    '(#22=(#23=&optional #24=(#25=(#26=bar #27=baz) #28=(5 6) #29=bar-baz-p))
      (:destructuring-lambda-list
       ((:optional-section . 1)
        (((:optional-section
           ((:keyword   . 1)
            (((:lambda-list-keyword () :keyword &optional :source #23#)))
            (:parameter . *)
            (((:optional-parameter
               ((:name     . 1) (((:pattern
                                   ((:required-section . 1)
                ...
                (:supplied . 1) (((:variable-name
                                   ()
                                   :name bar-baz-p :source #29#))))
               :source #24#)
              :evaluation :compound))))
          :evaluation :compound)))
       :source #22#))
    '(#30=(#31=&aux #32=a #33=(#34=b #35=1))
      (:destructuring-lambda-list
       ((:aux-section . 1)
        (((:aux-section
           ((:keyword   . 1) (((:lambda-list-keyword () :keyword &aux :source #31#)))
            (:parameter . *) (((:aux-parameter
                                ((:name . 1) (((:variable-name () :name a :source #32#))))
                                :source #32#)
                               :evaluation :compound)
                              ((:aux-parameter
                                ((:name  . 1) (((:variable-name () :name b :source #34#)))
                                 (:value . 1) (((:unparsed
                                                 ()
                                                 :expression 1 :context :form :source #35#)
                                                :evaluation t)))
                                :source #33#)
                               :evaluation :compound))))
          :evaluation :compound)))
    ...
    '(#36=(#37=a . #38=rest)
      (:destructuring-lambda-list
       ((:required-section . 1)
        (((:required-section
           ((:parameter . *) (((:required-parameter
                                ((:name . 1) (((:variable-name () :name a :source #37#)
                                               :evaluation nil)))
                                :source #37#)
                               :evaluation :compound))))
          :evaluation :compound))
        (:cdr . 1)
        (((:variable-name () :name rest :source #38#))))
       :source #36#))))
